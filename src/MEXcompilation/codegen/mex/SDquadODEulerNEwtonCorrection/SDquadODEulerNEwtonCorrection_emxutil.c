 ...
 *
 * SDquadODEulerNEwtonCorrection_emxutil.c
 *
 * Code generation for function 'SDquadODEulerNEwtonCorrection_emxutil'
 *
 */
...
/* End of code generation (SDquadODEulerNEwtonCorrection_emxutil.c) */
