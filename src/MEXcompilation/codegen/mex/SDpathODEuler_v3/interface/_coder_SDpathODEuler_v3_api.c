 ...
 *
 * _coder_SDpathODEuler_v3_api.c
 *
 * Code generation for function '_coder_SDpathODEuler_v3_api'
 *
 */
...
void SDpathODEuler_v3_api(const mxArray *const prhs[10], int32_T nlhs,
                          const mxArray *plhs[5])
{
  ...
  SDpathODEuler_v3(&st, h0, gCoeffs, SPs, cover_radii, valleys, base_step_size,
                   n_max, r_star, Newton_small_threshold, Newton_big_threshold,
                   p_log_out, h_log_out, (real_T *)valley_index_data,
...
/* End of code generation (_coder_SDpathODEuler_v3_api.c) */
