 ...
 *
 * SDpathODEuler_v4_emxutil.c
 *
 * Code generation for function 'SDpathODEuler_v4_emxutil'
 *
 */
...
{
  emxFree_creal_T(sp, &pStruct->contents);
}
...
void emxInitStruct_captured_var(const emlrtStack *sp, c_captured_var *pStruct,
                                const emlrtRTEInfo *srcLocation)
{
  emxInit_creal_T(sp, &pStruct->contents, 1, srcLocation);
}

void emxInitStruct_captured_var1(const emlrtStack *sp, d_captured_var *pStruct,
                                 const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->contents, 1, srcLocation);
}

void emxInitStruct_captured_var2(const emlrtStack *sp, c_captured_var *pStruct,
                                 const emlrtRTEInfo *srcLocation)
{
  emxInit_creal_T(sp, &pStruct->contents, 2, srcLocation);
}
...
/* End of code generation (SDpathODEuler_v4_emxutil.c) */
