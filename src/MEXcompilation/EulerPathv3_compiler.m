...
codegen SDpathODEuler_v3 -args {h0_type, gCoeffs_type, SPs_type, cover_radii_type, valleys_type, base_step_size, n_max_type, r_star_type, Newton_threshold_type, Newton_threshold_type}