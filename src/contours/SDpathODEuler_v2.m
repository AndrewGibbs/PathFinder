function [p_log_out, h_log_out, valley_index, ball_index, success] = ...
    SDpathODEuler_v2(h0, gCoeffs, SPs, cover_radii, valleys, base_step_size, n_max, r_star) %#codegen
...
%     n_max = 1000;
    ...
    halt_euler = @(h) inAball(h, SPs, cover_radii) || beyondNoReturn_v2(h,valleys,gCoeffs,r_star);%beyondNoReturn_v2(h,Cnr,argBeta,valleys);
