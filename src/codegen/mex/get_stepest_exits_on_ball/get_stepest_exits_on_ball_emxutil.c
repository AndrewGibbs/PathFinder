 ...
 *
 * get_stepest_exits_on_ball_emxutil.c
 *
 * Code generation for function 'get_stepest_exits_on_ball_emxutil'
 *
 */
...
/* End of code generation (get_stepest_exits_on_ball_emxutil.c) */
